...
class DistributedDispenser(BaseObject):
    ...
    if not IS_CLIENT:
        ...
        def onFinishConstruction(self):
            ...
            self.setModel("models/buildables/dispenser_light")

        def generate(self):
            self.setModel("models/buildables/dispenser")
        ...
        def onBecomeActive(self):
            ...
            self.nextAmmoDispense = base.clock.getFrameTime() + 0.5
        ...
        def __dispense(self, task):
            if self.nextAmmoDispense <= base.clock.getFrameTime():
                numNearbyPlayers = 0
                ...
                for plyr in base.game.playersByTeam[self.team]:
                    ...
                    numNearbyPlayers += 1
                self.nextAmmoDispense = base.clock.getFrameTime()
