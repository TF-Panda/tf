...
ChooseAClass = "Sélectionnez une équipe"
ChooseATeam = "Sélectionnez une classe"
...
# Engineer Weapons
SentryGun = 'Mitrailleuse'
Dispenser = 'Distributeur'
Teleporter = 'Téléporteur'
Wrench = 'Clé'
Pistol = 'Pistolet'
#Shotgun = 'Fusil à pompe'
ConstructionPDA = 'PDA de Construction'
DestructionPDA = 'PDA de Destruction'
# Shared
Toolbox = 'Boîte à outils'
Object = 'Objet'
ObjectNotBuilt = '%s non montée'
ObjectAlreadyBuilt =  "Déjà monté"
NotBuilt = 'Non monté(e)'
BUILD = "MONTER"
Building = 'Montage...'
NotEnoughMetal = "Métal Insuffisant"
BuiltBy = " monté(e) par "
Metal = "\nMétal : %i"
...
Rockets = 'Roquettes'
Upgrade = 'Améliorer'
SentryKillsText = 'Victimes : %i (%i)'
Level = "\nNiveau %i"
UpgradeProgress = "\nProgression de l'amélioration : %i / %i"
# Teleporter
Entrance = 'Entrée'
Exit = 'Sortie'
...
# Medic Weapons
MediGun = 'Trousse de secours'
BoneSaw = 'Scie à amputation'
SyringeGun = 'Pistolet à seringues'
Healer = "Soigneur : "
Healing = "Soins : "

# Spy Weapons
Revolver = 'Revolver'
InvisWatch = 'Montre d\'invisibilité'
DiguiseKit = 'Kit de Déguisement'
Knife = 'Couteau'
...
# Demoman Weapons
Bottle = 'Bouteille'
StickyBombLauncher = 'Lanceur de bombes collantes'
...
YouWereKilledByNemesis = "Vous avez encore été tué par "
YouWereKilledByThe = "Vous avez été tué par "
YouWereKilledByTheNemesis = "Vous avez encore été tué par "
KillerLate = "feu "
KillerSentryGun = "Mitrailleuse de "
KillerTheLate = "the late "
PlayerFinishedOff = "\2 a achevé "
PlayerKilled = " a tué "
...
ChatDeadPrefix = "*MORT*"
ChatVoicePrefix = "(VOIX)"
ChatTeamPrefix = "(ÉQUIPE)"
ChatJoinedGame = "Le joueur %s a rejoint la partie."
ChatLeftGame = "%s a quitté la partie."
ChatJoinedTeam = "Le joueur %s a rejoint l'équipe %s."
ChatJoinedTeamAuto = "Le joueur %s a rejoint automatiquement l'équipe %s."
...
TF_TeamsSwitched = "Les équipes ont été inversées."
