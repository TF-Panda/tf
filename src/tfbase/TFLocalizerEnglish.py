...
ChatTeamPrefix = "(Team)"
ChatJoinedGame = "%s joined the game."
ChatLeftGame = "%s disconnected."
...
ChatCannotChangeClass = "Cannot change class at this time."
ChatCannotChangeTeam = "Cannot change team at this time."
