...
ConnectionFailed = 'Failed to connect to %s.  Try again?'
...
WinPanelHeadingTeamWins = "%s TEAM WINS!"
WinPanelHeadingSeizesArea = "%s SEIZES AREA!"
WinPanelHeadingStalemate = "STALEMATE!" # "You're all losers!"
WinPanelReasonStalemate = "No team completed the objective."
WinPanelReasonDefended = "%s successfully defended until time ran out."
WinPanelReasonCaptured = "%s captured all control points."
