...
class TFWeapon(BaseClass):
    ...
    actTable = {
        ...
        TFWeaponType.Secondary: {
            ...
            Activity.Attack_Stand_Prefire: Activity.Secondary_Attack_Stand_Prefire,
            Activity.Attack_Stand_Postfire: Activity.Secondary_Attack_Stand_Postfire,
            Activity.Attack_Crouch: Activity.Secondary_Attack_Crouch,
            Activity.Attack_Crouch_Prefire: Activity.Secondary_Attack_Crouch_Prefire,
            Activity.Attack_Crouch_Postfire: Activity.Secondary_Attack_Crouch_Postfire,
